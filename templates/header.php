...
if(isset($_SESSION['user_id'])): ?>
        <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin-bottom: 20px; text-align: right; border: 1px solid #ddd;">
            ...
            <a href="/templates/manage_event.php" style="text-decoration: none; color: #27ae60;">➕ สร้างกิจกรรมใหม่</a> &nbsp;|&nbsp;
            <a href="/templates/manage_event.php" style="text-decoration: none; color: black;">➕ จัดการกิจกรรม</a> &nbsp;|&nbsp;
