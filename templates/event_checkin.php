...
<body>
    ...
    <div class="container">
        ...
        <h3>รายชื่อผู้เข้าร่วมทั้งหมด (ระบบสำรอง)</h3>
        <table>
            <thead>
                <tr>
                    <th>รหัสสมัคร</th>
            ...
            <tbody>
                ...
                if (!empty($registrations)): 
                    foreach ($registrations as $reg): 
                        // ใช้ strtolower เพื่อป้องกันปัญหาตัวพิมพ์เล็ก/ใหญ่ (Approved vs approved)
                        if (strtolower($reg['status']) == 'approved'): 
                            $has_approved_users = true;
                ?>
                    <tr style="<?php echo ($reg['is_checked_in'] == 1) ? 'background-color: #f8fff8;' : ''; ?>">
                ...
                ?>
                    <tr>
                        <td colspan="5" style="padding: 30px; color: #888;">ยังไม่มีผู้เข้าร่วมที่ได้รับการอนุมัติในกิจกรรมนี้</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
